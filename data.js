...
const frutas = [
    ...
    },
    {
        id: 14,
        nombre: 'Granada',
        foto: 'https://www.atida.com/es-es/blog/wp-content/uploads/2022/05/36-blog.png',
        colorPrincipal: 'rojo',
        esDulce: true,
        temporada: 'otoño',
        esImportada: false,
    ...
    },
    {
        id: 21,
        nombre: 'Tomate',
        foto: 'https://s3.abcstatics.com/media/gurme/2022/05/30/s/tomates.jpg-kjrC--1024x512@abc.jpg',
        colorPrincipal: 'rojo',
        esDulce: false,
        temporada: 'invierno',
        esImportada: false,
        stock: 60,
        precio: 70,
        descripcion: 'El pomelo es saludable y ligeramente acido. Se consume en ensaladas y jugos.'
    },
]